...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : dim. 04 fév. 2024 à 10:10
...
CREATE TABLE IF NOT EXISTS `categorie` (
  `cat_id` int NOT NULL AUTO_INCREMENT COMMENT 'Identifiant de la categorie',
...
DROP TABLE IF EXISTS `categorie_utrip`;
CREATE TABLE IF NOT EXISTS `categorie_utrip` (
  `cat_utrip_id` int NOT NULL AUTO_INCREMENT COMMENT 'Numéro de l''association catégorie utrip',
  `cat_utrip_utrip_id` int NOT NULL COMMENT 'Identifiant de récit de voyage',
  `cat_utrip_cat_id` int NOT NULL COMMENT 'Identifiant de la categorie',
...
CREATE TABLE IF NOT EXISTS `city` (
  `city_id` int NOT NULL AUTO_INCREMENT COMMENT 'Identifiant de la ville',
...
CREATE TABLE IF NOT EXISTS `comments` (
  `com_id` int NOT NULL AUTO_INCREMENT COMMENT 'Numéro de l''association entre utrip et user',
  ...
  `com_user_id` int NOT NULL COMMENT 'Utilisateur qui a commenté',
  `com_utrip_id` int NOT NULL COMMENT 'Récit de voyage sur lequel il a commenté',
  PRIMARY KEY (`com_id`),
...
CREATE TABLE IF NOT EXISTS `contact` (
  `contact_id` int NOT NULL AUTO_INCREMENT COMMENT 'Identifiant du contact (formulaire)',
...
CREATE TABLE IF NOT EXISTS `country` (
  `country_id` int NOT NULL AUTO_INCREMENT COMMENT 'Identifiant du pays',
...
CREATE TABLE IF NOT EXISTS `image` (
  `img_id` int NOT NULL AUTO_INCREMENT COMMENT 'Identifian de la image',
...
CREATE TABLE IF NOT EXISTS `is_located` (
  `loc_id` int NOT NULL AUTO_INCREMENT COMMENT 'Numéro de l''association utrip-city',
  `loc_city_id` int NOT NULL COMMENT 'Identifiant de la ville',
  `loc_utrip_id` int NOT NULL COMMENT 'Identifiant de utrip',
  PRIMARY KEY (`loc_id`),
...
CREATE TABLE IF NOT EXISTS `likes` (
  `like_id` int NOT NULL AUTO_INCREMENT COMMENT 'Numéro de l''association entre utrip et user',
  `like_date` datetime NOT NULL COMMENT 'Date du like',
  `like_user_id` int NOT NULL COMMENT 'User qui a réagit',
  `like_utrip_id` int NOT NULL COMMENT 'Récit du voyage qui a une réaction',
  PRIMARY KEY (`like_id`),
...
CREATE TABLE IF NOT EXISTS `topic` (
  `topic_id` int NOT NULL AUTO_INCREMENT COMMENT 'Identifiant du topic',
...
DROP TABLE IF EXISTS `utrip`;
CREATE TABLE IF NOT EXISTS `utrip` (
  `utrip_id` int NOT NULL AUTO_INCREMENT COMMENT 'Identifiant de récit e voyage',
  ...
  `utrip_budget` int DEFAULT NULL COMMENT 'Budget estimé du voyage',
...
ALTER TABLE `categorie`
  ADD CONSTRAINT `FK_categorie_cat_parent` FOREIGN KEY (`cat_parent`) REFERENCES `categorie` (`cat_id`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Contraintes pour la table `categorie_utrip`
--
ALTER TABLE `categorie_utrip`
  ADD CONSTRAINT `FK_categorie_utrip_cat_utrip_id_cat_id` FOREIGN KEY (`cat_utrip_cat_id`) REFERENCES `categorie` (`cat_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `FK_categorie_utrip_cat_utrip_id_utrip_id` FOREIGN KEY (`cat_utrip_utrip_id`) REFERENCES `utrip` (`utrip_id`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Contraintes pour la table `city`
--
ALTER TABLE `city`
  ADD CONSTRAINT `FK_city_city_country_id` FOREIGN KEY (`city_country_id`) REFERENCES `country` (`country_id`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Contraintes pour la table `comments`
--
ALTER TABLE `comments`
  ADD CONSTRAINT `FK_comments_com_user_id` FOREIGN KEY (`com_user_id`) REFERENCES `users` (`user_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `FK_comments_com_utrip_id` FOREIGN KEY (`com_utrip_id`) REFERENCES `utrip` (`utrip_id`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Contraintes pour la table `contact`
--
ALTER TABLE `contact`
  ADD CONSTRAINT `FK_contact_contact_user_id` FOREIGN KEY (`contact_user_id`) REFERENCES `users` (`user_id`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Contraintes pour la table `country`
--
ALTER TABLE `country`
  ADD CONSTRAINT `FK_country_country_cont_id` FOREIGN KEY (`country_cont_id`) REFERENCES `continent` (`cont_id`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Contraintes pour la table `image`
--
ALTER TABLE `image`
  ADD CONSTRAINT `FK_image_img_utrip_id` FOREIGN KEY (`img_utrip_id`) REFERENCES `utrip` (`utrip_id`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Contraintes pour la table `is_located`
--
ALTER TABLE `is_located`
  ADD CONSTRAINT `FK_is_located_loc_city_id` FOREIGN KEY (`loc_city_id`) REFERENCES `city` (`city_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `FK_is_located_loc_utrip_id` FOREIGN KEY (`loc_utrip_id`) REFERENCES `utrip` (`utrip_id`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Contraintes pour la table `likes`
--
ALTER TABLE `likes`
  ADD CONSTRAINT `FK_likes_like_user_id` FOREIGN KEY (`like_user_id`) REFERENCES `users` (`user_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `FK_likes_like_utrip_id` FOREIGN KEY (`like_utrip_id`) REFERENCES `utrip` (`utrip_id`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Contraintes pour la table `topic`
--
ALTER TABLE `topic`
  ADD CONSTRAINT `FK_topic_topic_user_id` FOREIGN KEY (`topic_user_id`) REFERENCES `users` (`user_id`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Contraintes pour la table `users`
--
ALTER TABLE `users`
  ADD CONSTRAINT `FK_users_user_role_id` FOREIGN KEY (`user_role_id`) REFERENCES `role` (`role_id`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Contraintes pour la table `utrip`
--
ALTER TABLE `utrip`
  ADD CONSTRAINT `FK_utrip_utrip_user_id` FOREIGN KEY (`utrip_user_id`) REFERENCES `users` (`user_id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
COMMIT;
